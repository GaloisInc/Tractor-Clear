...
define noundef i32 @max_size_frame(i32 noundef %blocksize, i32 noundef %channels, i32 noundef %bitdepth) unnamed_addr #0 {
start:
  %self.i = add i32 %channels, 18
  %self1.i = mul i32 %bitdepth, %blocksize
  %_14.not.i = icmp eq i32 %channels, 2
  %rhs2.i = select i1 %_14.not.i, i32 0, i32 %channels
  %self3.i = mul i32 %self1.i, %rhs2.i
  %_23.i = icmp ne i32 %bitdepth, 32
  %rhs8.i = zext i1 %_23.i to i32
  %rhs9.i = add i32 %rhs8.i, %bitdepth
  %self10.i = mul i32 %rhs9.i, %blocksize
  %rhs12.i = select i1 %_14.not.i, i32 %self10.i, i32 0
  %self1.op.i = add i32 %self1.i, 7
  %self7.i = select i1 %_14.not.i, i32 %self1.op.i, i32 7
  %self13.i = add i32 %self7.i, %self3.i
  %self14.i = add i32 %self13.i, %rhs12.i
  %rhs1516.i = lshr i32 %self14.i, 3
  %0 = add i32 %self.i, %rhs1516.i
  ret i32 %0
}
