...
define void @driver(i32 noundef %floors) unnamed_addr #0 {
start:
  ...
  %byte.i.i = alloca ptr, align 8
  %bytes.i = alloca [16 x i8], align 4
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %bytes.i)
  store i32 %floors, ptr %bytes.i, align 4
  %0 = getelementptr inbounds i8, ptr %bytes.i, i64 4
  store i32 3, ptr %0, align 4
  %1 = getelementptr inbounds i8, ptr %bytes.i, i64 8
  store i64 4611686018427387904, ptr %1, align 4
  %2 = getelementptr inbounds { ptr, ptr }, ptr %_13.i.i, i64 0, i32 1
  ...
  %3 = getelementptr inbounds %"core::fmt::Arguments<'_>", ptr %_9.i.i, i64 0, i32 1
  %4 = getelementptr inbounds %"core::fmt::Arguments<'_>", ptr %_9.i.i, i64 0, i32 1, i32 1
  %5 = getelementptr inbounds { ptr, i64 }, ptr %_9.i.i, i64 0, i32 1
  %6 = getelementptr inbounds %"core::fmt::Arguments<'_>", ptr %_9.i.i, i64 0, i32 2
  %7 = getelementptr inbounds %"core::fmt::Arguments<'_>", ptr %_9.i.i, i64 0, i32 2, i32 1
  br label %bb4.i.i

bb4.i.i:                                          ; preds = %bb4.i.i, %start
  %iter.sroa.4.0.idx4.i.i = phi i64 [ 0, %start ], [ %iter.sroa.4.0.add.i.i, %bb4.i.i ]
  %iter.sroa.4.0.ptr.i.i = getelementptr inbounds i8, ptr %bytes.i, i64 %iter.sroa.4.0.idx4.i.i
  %iter.sroa.4.0.add.i.i = add nuw nsw i64 %iter.sroa.4.0.idx4.i.i, 1
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %byte.i.i), !noalias !2
  store ptr %iter.sroa.4.0.ptr.i.i, ptr %byte.i.i, align 8, !noalias !2
  ...
  store ptr %byte.i.i, ptr %_13.i.i, align 8, !noalias !2
  store ptr @"_ZN45_$LT$$RF$T$u20$as$u20$core..fmt..LowerHex$GT$3fmt17hc149eb844b7f0cd8E", ptr %2, align 8, !noalias !2
  ...
  store ptr @alloc_ffa3cdb3ae88e54a1cc225f31dd07672, ptr %3, align 8, !noalias !2
  store i64 1, ptr %4, align 8, !noalias !2
  store ptr %_18.i.i, ptr %_9.i.i, align 8, !noalias !2
  store i64 1, ptr %5, align 8, !noalias !2
  store ptr %_13.i.i, ptr %6, align 8, !noalias !2
  store i64 1, ptr %7, align 8, !noalias !2
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %byte.i.i), !noalias !2
  %_10.i.i.i = icmp eq i64 %iter.sroa.4.0.add.i.i, 16
  br i1 %_10.i.i.i, label %_ZN6driver3src6driver6driver17h1ffc857099aa3b67E.exit, label %bb4.i.i

_ZN6driver3src6driver6driver17h1ffc857099aa3b67E.exit: ; preds = %bb4.i.i
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %_24.i.i), !noalias !2
  %8 = getelementptr inbounds %"core::fmt::Arguments<'_>", ptr %_24.i.i, i64 0, i32 1
  store ptr @alloc_c9ee96391497c38d8031dd5302a0dd52, ptr %8, align 8, !alias.scope !5, !noalias !2
  %9 = getelementptr inbounds %"core::fmt::Arguments<'_>", ptr %_24.i.i, i64 0, i32 1, i32 1
  store i64 1, ptr %9, align 8, !alias.scope !5, !noalias !2
  store ptr null, ptr %_24.i.i, align 8, !alias.scope !5, !noalias !2
  %10 = getelementptr inbounds %"core::fmt::Arguments<'_>", ptr %_24.i.i, i64 0, i32 2
  store ptr @alloc_513570631223a12912d85da2bec3b15a, ptr %10, align 8, !alias.scope !5, !noalias !2
  %11 = getelementptr inbounds %"core::fmt::Arguments<'_>", ptr %_24.i.i, i64 0, i32 2, i32 1
  store i64 0, ptr %11, align 8, !alias.scope !5, !noalias !2
...
!2 = !{!3}
!3 = distinct !{!3, !4, !"_ZN6driver3src6driver9print_hex17he320f901d24d5f67E: %bytes.0"}
