...
define void @sieve(i32 noundef %val) unnamed_addr #0 {
start:
...
bb1.i:                                            ; preds = %bb1.i, %start
  %storemerge.i = phi i32 [ %val, %start ], [ %6, %bb1.i ]
  ...
  store ptr %val.i, ptr %_7.i, align 8
  ...
  store ptr null, ptr %_3.i, align 8, !alias.scope !2, !noalias !5
  store ptr %_7.i, ptr %3, align 8, !alias.scope !2, !noalias !5
  ...
  %_11.i = load i32, ptr %val.i, align 4, !noundef !7
  %_10.i = srem i32 %_11.i, 10
  %5 = icmp eq i32 %_10.i, 9
  %6 = add i32 %_11.i, 1
  br i1 %5, label %_ZN5Sieve3src5sieve5sieve17hbe55f61e6f41876aE.exit, label %bb1.i

_ZN5Sieve3src5sieve5sieve17hbe55f61e6f41876aE.exit: ; preds = %bb1.i
